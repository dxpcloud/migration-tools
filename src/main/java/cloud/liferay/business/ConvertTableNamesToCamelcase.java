package cloud.liferay.business;
...
public class ConvertTableNamesToCamelcase {
	...
	public static void main(String[] args) throws Exception {
		...
		while (rsTables.next()) {
			...
			if (lowercaseTableName.equals(originalTableName)) {
				System.out.println("Skipping the processing of the table: "
						+ originalTableName);
				continue;
			}
			...
			if (!exist) {
				System.out.println("Skipping the processing of the table: "
						+ originalTableName
						+ " because it was already imported!");
				continue;
			}
